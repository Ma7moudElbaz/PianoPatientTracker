...
public class RankingDetails_hospitals_item {
    int id;
    String name, sector,address;
    int doctorsNo,patientsNo;

    public RankingDetails_hospitals_item(int id, String name, String sector, String address, int doctorsNo, int patientsNo) {
        this.id = id;
        this.name = name;
        this.sector = sector;
