...
public class SectorsSpinnerAdapter extends BaseAdapter {
    Context context;
    ArrayList<Sector_item> items;
    LayoutInflater inflater;

    public SectorsSpinnerAdapter(Context applicationContext, ArrayList<Sector_item> items) {
