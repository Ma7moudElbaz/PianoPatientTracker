...
import com.novartis.global.gbl.onlinepatienttracker.admin_manager_regional.ranking.ranking_details.RepSectorDetailsActivity;
    ...
    public void onBindViewHolder(@NonNull Ranking_sectors_adapter.ViewHolder holder, final int position) {
        ...
        holder.parent_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(mContext, RepSectorDetailsActivity.class);
